...
addp1.append(mpf.make_addplot(rsi,panel='lower',secondary_y=False))
addp1.append(mpf.make_addplot([30]* len(rsi),panel='lower',secondary_y=False,color='red'))
addp1.append(mpf.make_addplot([70]* len(rsi),panel='lower',secondary_y=False,color='red'))
